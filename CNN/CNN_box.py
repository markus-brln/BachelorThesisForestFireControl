...
def build_model(input_shape):
    ...
    model.compile(loss=['kullback_leibler_divergence', 'mse'], # kullback_leibler_divergence
                  optimizer='adam',
                  metrics=['categorical_accuracy', 'mse']) ##not sure if metric is correct (maybe try mse)
