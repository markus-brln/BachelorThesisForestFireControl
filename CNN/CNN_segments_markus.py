...
if __name__ == "__main__":
    ...
    callback = tf.keras.callbacks.EarlyStopping(monitor='val_seg_categorical_accuracy', restore_best_weights=True, patience=4)
    ...
    plot_history_segments(history=history)
