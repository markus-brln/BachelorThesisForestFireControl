...
def plot_history_segments(history):
  # function taken from https://github.com/musikalkemist/DeepLearningForAudioWithPython
  """Plots accuracy/loss for training/validation set as a function of the epochs
      :param history: Training history of model
      :return:
  ...
  # create accuracy sublpot
  axs[0].plot(history.history["seg_categorical_accuracy"], label="train accuracy")
  axs[0].plot(history.history["val_seg_categorical_accuracy"], label="validation accuracy")
  axs[0].set_ylabel("Accuracy")
  axs[0].legend(loc="lower right")
  axs[0].set_title("Accuracy eval")
...
def plot_history_dig(history):
  ...
  # create accuracy sublpot
  axs[0].plot(history.history['dig_categorical_accuracy'], label="train accuracy")
  axs[0].plot(history.history['val_dig_categorical_accuracy'], label="validation accuracy")
